...
<html>
    ...
    <br>
    <br>
    <form class="w3-container w3-card-4" action="http://localhost:8080/cidadao/cadastrar" method="POST">
      <h2 class="w3-text-blue">Formulário de cadastro</h2>
      <p>      
          <label class="w3-text-blue"><b>CPF: </b></label>
          <input class="w3-input w3-border" name="cpf" type="text">
      </p>
      <p>      
          <label class="w3-text-blue"><b>Nome completo: :</b></label>
          <input class="w3-input w3-border" name="nome_completo" type="text">
      </p>
      <p>      
      ...
      <p>      
          ...
          <input class="w3-input w3-border" name="data_nasc" type="text">
      </p>
      <p>      
          <label class="w3-text-blue"><b> Celular :</b></label>
          <input class="w3-input w3-border" name="num_celular" type="number">
      </p>
      <p>      
